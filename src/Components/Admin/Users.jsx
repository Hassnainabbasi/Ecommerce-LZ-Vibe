...
export default function Users() {
  ...
  if (loading) {
    return <div className="text-gray-800 p-4">Loading users...</div>
  }
...
{/* 
      <div className="mb-4 lg:mb-6 flex flex-col sm:flex-row gap-2">
        ...
        <button className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-800 transition-colors text-sm lg:text-base">
          Export Text
        </button>
      </div> */}

      <div className="overflow-x-auto bg-white border-2 border-slate-200 rounded-lg shadow-lg">
