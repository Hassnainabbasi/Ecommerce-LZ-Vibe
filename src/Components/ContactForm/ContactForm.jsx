  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="mb-8 text-center text-slate-600">
        Send us a message about orders, shipping, or products. We typically reply within one business day.
      </p>
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-5 items-start">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-wrap gap-4">
            {["Order status", "Shipping & delivery", "Returns & refunds", "Other"].map(
              (subj) => (
