...
export default function BankDetails() {
    ...
    return (
        <section className=" text-gray-200 py-10 px-4 md:px-10">
            <div className="max-w-3xl mx-auto bg-[#111] shadow-[0_0_25px_rgba(255,107,157,0.2)] rounded-2xl p-8 border border-[#222]">
                
                {/* Heading */}
                <h2 className="text-3xl font-bold text-center mb-8">
                    <span className="text-blue-600">Bank</span> Transfer Details
                </h2>
                ...
                <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-xl p-6 mb-8 shadow-inner">
                    ...
                    <p className="text-gray-300 mt-2">
                        ...
                        <span className="text-blue-600">07060109362467</span>
                    </p>
                    <p className="text-gray-300 mt-2">
                        <span className="font-medium text-gray-400">IBAN:</span>{" "}
                        <span className="text-blue-600">PK19MEZN0007060109362467</span>
                    </p>
                </div>
